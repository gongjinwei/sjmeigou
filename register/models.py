...
class VideoStream(models.Model):
    metaData=models.ForeignKey(to='VodMetaData',on_delete=models.DO_NOTHING,related_name='videoStreamList',editable=False)
...
class AudioStream(models.Model):
    metaData=models.ForeignKey(to='VodMetaData',on_delete=models.DO_NOTHING,related_name='audioStreamList',editable=False)
